...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{./images/mono/baseline2.png}	
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{./images/mono/new_model.png}	
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{./images/poly/baseline.png}	
